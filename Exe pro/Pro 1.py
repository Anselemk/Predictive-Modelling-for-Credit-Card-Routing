...
#This section of code defines 4 columns as our model targets which 1column belongs to one of the PSPs.
# If a transaction is successful on any of PSPs, we consider as 1 in the corresponding  PSP column and we mention 0 into three others.
...
#Import libraries to design the model
import pandas as pd
import numpy as np
